...
function SpotlightCard({ children, className = "" }) {
	return (
        ...
        before:absolute before:w-80 before:h-80 before:-left-40 
        before:-top-40 before:bg-slate-400 before:rounded-full 
        ...
        after:bg-indigo-500 after:rounded-full after:opacity-0 
        ...
        after:hover:opacity-10 after:z-30 after:blur-[100px] 
